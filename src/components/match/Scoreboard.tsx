      ...
      <Card className="p-4">
        <div className="flex items-center justify-center gap-6">
          <div className="text-center flex flex-col items-center">
            {homeConfig.logoUrl && (
              <img src={homeConfig.logoUrl} alt={homeConfig.name} className="w-10 h-10 object-contain mb-1" referrerPolicy="no-referrer" />
            )}
          ...
          <div className="text-center flex flex-col items-center">
            {awayConfig.logoUrl && (
              <img src={awayConfig.logoUrl} alt={awayConfig.name} className="w-10 h-10 object-contain mb-1" referrerPolicy="no-referrer" />
            )}
